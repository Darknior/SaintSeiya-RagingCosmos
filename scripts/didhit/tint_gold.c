...
void main()
{
	...
	tintEffect(openborconstant("ANI_FREESPECIAL2"), "gold", 1);
	tintEffect(openborconstant("ANI_FREESPECIAL3"), "gold", 1);
	tintEffect(openborconstant("ANI_FREESPECIAL6"), "gold", 1);
}